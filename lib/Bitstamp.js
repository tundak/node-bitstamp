...
class Bitstamp {
    ...
    btcWithdrawal(amount, address){
        ...
        return this.call(this._resolveEP(ep, null), HTTP_METHOD.POST, body, true, false);
    }

    tetherWithdrawal(amount, address){
    ...
    tradeFee(){
        const ep = "fees/trading";
        return this.call(this._resolveEP(ep, null), HTTP_METHOD.POST, {}, true, false);
    }

    withdrawFee(){
        const ep = "fees/withdrawal";
        return this.call(this._resolveEP(ep, null), HTTP_METHOD.POST, {}, true, false);
    }

    cryptoWithdrawStatus(){
        const ep = "withdrawal-requests";
        return this.call(this._resolveEP(ep, null), HTTP_METHOD.POST, {}, true, false);
    }
}
